...
// 이미지를 보여주는 컴포넌트
// ==========================================
function ToolRowWithImage({ name, type, price, desc, Icon, imageUrl }) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md hover:border-blue-200 transition-all p-5 flex flex-col lg:flex-row gap-6 items-center">
      ...
      <div className="w-full lg:w-2/3 bg-gray-50 rounded-xl overflow-hidden border border-gray-200 relative group flex items-center justify-center shadow-inner min-h-[160px]">
        <img 
          src={imageUrl} 
          alt={`${name} 요금제`} 
